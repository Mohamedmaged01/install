...
const STATUS_CONFIG: Record<OrderStatus, { color: string; bg: string; label: string; labelAr: string }> = {
    ...
    PendingSalesSupervisorApproval: { color: '#f59e0b', bg: 'rgba(245,158,11,0.12)', label: 'Pending Sales', labelAr: 'انتظار مشرف المبيعات' },
    PendingInstallationSupervisorApproval: { color: '#8b5cf6', bg: 'rgba(139,92,246,0.12)', label: 'Pending Installation', labelAr: 'انتظار مشرف التركيب' },
    ...
    Completed: { color: '#10b981', bg: 'rgba(16,185,129,0.12)', label: 'Completed', labelAr: 'مكتمل' },
